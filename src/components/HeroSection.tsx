  ...
  return (
    <section className="pt-20 pb-16 text-center" style={{ background: 'linear-gradient(180deg, #fbfbfd 0%, #f5f5f7 100%)' }}>
      <div className="max-w-[980px] mx-auto px-6">
        ...
        <h1 className="text-[36px] sm:text-[56px] md:text-[80px] font-semibold tracking-[-0.015em] leading-[1.05] text-apple-text mb-4 sm:mb-6 fade-up fade-up-1">
          Maarif Hafıza
        </h1>

        <p className="text-lg sm:text-xl md:text-2xl text-apple-text-secondary font-normal max-w-[600px] mx-auto mb-2 sm:mb-3 leading-relaxed fade-up fade-up-2">
          Öğretmen deneyimini okulun ortak hafızasına dönüştürür.
        </p>

        <p className="text-base sm:text-lg text-apple-text-tertiary font-normal mb-8 sm:mb-10 fade-up fade-up-2">
          Sınıfta doğan bilgi kaybolmaz.
        </p>

        <div className="flex items-center justify-center gap-4 mb-10 sm:mb-16 fade-up fade-up-3">
          <button
            onClick={onStartDemo}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-0 max-w-[720px] mx-auto fade-up fade-up-4">
          {[
            ...
            <div key={i} className="relative text-center px-2">
              {i < 3 && (
                <div className="hidden sm:block absolute top-5 left-[60%] w-[80%] h-px bg-apple-border" />
              )}
